...
export default function AboutPage() {
  ...
  <div className="w-54 h-63 bg-gradient-to-tr from-pink-500 to-purple-500 rounded-full flex items-center justify-center p-0.5 mb-5 shadow-lg shadow-purple-500/10 overflow-hidden">
  <div className="w-full h-full rounded-full overflow-hidden bg-[#070B16] relative">
    <img
        src="./Gemini_Generated_Image_lzsrnblzsrnblzsr.png" 
